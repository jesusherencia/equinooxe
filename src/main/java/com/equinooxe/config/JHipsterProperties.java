...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "equinooxe@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "equinooxe API";

        private String description = "equinooxe API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "equinooxe";
